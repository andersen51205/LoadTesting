...
Route::group(['prefix' => 'backend', 'middleware' => 'auth'], function() {
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['user', 'verified.email']], function() {
        ...
        Route::get('/Project/{projectId}/edit', 'User\ProjectController@edit')->name('User_Project_Edit');
    ...
    Route::group(['prefix' => 'manager', 'middleware' => ['manager', 'verified.email']], function() {
        ...
        Route::get('/Project/{projectId}/edit', 'Manager\ProjectController@edit')->name('Manager_Project_Edit');
