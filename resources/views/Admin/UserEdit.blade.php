                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header p-3 align-middle text-center">
                                        <h3 class="m-2 align-middle d-inline"><i class="fa-solid fa-user-pen"></i> 編輯管理員</h3>
                                    </div>
                                    <div class="card-body">
                                        <form id="Form_user_information" method="POST" action="{{-- axios --}}">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-6 offset-3">
                                                    ...
                                                    <input type="text" id="Input_name" class="form-control necessary"
                                                        name="name" value="{{ $data['userData']['name'] }}">
                                                </div>
                                            </div>
                                            {{-- 電子郵件 --}}
                                            <div class="row mb-3">
                                                <div class="col-6 offset-3">
                                                    ...
                                                    <input type="email" id="Input_email" class="form-control necessary"
                                                        name="email" value="{{ $data['userData']['email'] }}" disabled>
                                                </div>
                                            </div>
                                            {{-- 舊密碼 --}}
                                            {{-- <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-6 offset-3">
                                                    ...
                                                    <input type="password" id="Input_password_confirm" class="form-control"
                                            ...
                                            <div class="row mb-0">
                                                <div class="col-6 offset-3 d-flex justify-content-center">
                                                    <button type="button" class="btn btn-primary"
                                                            ...
                                                            data-submit-type="update" onclick="submitForm(this)">
                                                        送出
                                                    </button>
