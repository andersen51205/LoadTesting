...
@section('content')
    <div class="sb-nav-fixed">
        <div id="layoutSidenav">
            {{-- 側邊欄 --}}
            @include('layouts.Manager.ResultSidenav')
            {{-- 內容 --}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-outline-danger"
                                                        href="{{ route('Manager_TestScript_Download', $data['testScriptData']['id']) }}">
                        ...
                        <div class="row">
                            <div class="col-12 px-4 py-2 text-center">
                                ...
                                <a class="btn btn-secondary m-1"
                                        href="{{ route('Manager_Project_View', $data['testScriptData']['project_id']) }}">
                                    返回列表
                                </a>
                            </div>
                        </div>
...
@section('script')
    @include('JS_view.Manager.TestResultOverview')
@endsection
